...
class Vehicle:
    ...
    def buy(customer_name, customer_phone, vehicle_id, vehicle_type):
        ...
        add_purchase(customer_name, customer_phone, vehicle_id, vehicle_type)

        print(f"{vehicle_type} with ID {vehicle_id} has been purchased by {customer_name}.")
...
class Customer:
    ...
    def display_purchases(self):
        ...
        try:
            ...
            print(f"An error occurred while fetching purchases: {e}")
